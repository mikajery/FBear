class DesignersController < Admin::BaseController
  ...
  def create
    ...
    respond_to do |format|
      if @designer.save
        format.html { redirect_to designers_url, notice: 'Designer was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @designer.update(designer_params)
        format.html { redirect_to designers_url, notice: 'Designer was successfully updated.' }
